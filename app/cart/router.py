"""Shopping cart and coupon routes."""
...
@router.post("/items/{item_id}/save-for-later", response_model=CartItemResponse)
...
@router.post("/items/{item_id}/move-to-cart", response_model=CartItemResponse)
...
@router.post("/apply-coupon", response_model=CartSummary)
...
async def update_coupon(
    ...
    return CouponResponse.model_validate(CouponService(db).update(coupon_id, payload))
